...
for category in [VDB,nVDB]:
    ...
    if category == VDB:
        ...
        plt.savefig(output_folder + '/V_graph_VDB.pdf', dpi=300)
    else:
        plt.title('Change in behavior around laser epoch\n Behaviors: Rearing,Other,BTC,Jump')
        plt.savefig(output_folder + '/V_graph_nVDB.pdf', dpi=300)
    plt.close()
